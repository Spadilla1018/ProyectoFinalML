...
def upload():
    ...
    try:
        ...
        try:
            ...
            if df.shape[1] == 1:
                # Si vino todo en una columna, reintentar lectura normal
                df = pd.read_csv(path)
        except Exception:
            df = pd.read_csv(path)
        ...
        # Guardar el path del dataset en la sesión para insights
...
# ---------- subir CSV de lecturas (batch_detail.html) ----------
